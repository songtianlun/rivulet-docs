...
const T = {
    zh: {
        ...
        q1: '溪流记账完全免费吗？',
        a1: '是的，溪流记账是完全免费的软件，可以使用 Docker 自托管，完全自主掌控您的数据。可以免费使用官网 Demo 服务测试，如果需要也可期待官方提供的更稳定的 SaaS 服务。',
        q2: '我的数据安全吗？',
        a2: '数据存储在你自己部署的服务器上（或官方 Demo 服务器），我们不会出售或分析你的个人财务数据。强烈建议自部署以获得完整数据控制权。另一方面，软件提供了方便的数据导出和导入功能，让你可以随时备份和迁移数据到其他平台。',
        q3: '支持哪些平台？',
    ...
    en: {
        ...
        a1: 'Yes. Rivulet is completely free. You can use the official demo service for testing, or self-host it using Docker for full control over your data. A more stable SaaS service may be available in the future.',
        q2: 'Is my data safe?',
        a2: 'Data is stored on your own self-hosted server (or the official demo server). We do not sell or analyze your personal financial data. Self-hosting is strongly recommended for full data control. The software also provides easy data export and import features, allowing you to back up and migrate your data to other platforms at any time.',
        ...
        footer_open: 'Supports Self-Hosting · Full Control Over Your Data',
    },
};
